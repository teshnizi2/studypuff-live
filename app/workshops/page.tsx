...
const TIERS: Tier[] = [
  ...
  },
  {
    ...
    bullets: ["1 session", "Personalized advice", "Workbook", "Personal Discord/WhatsApp Group"],
    tone: "bg-brand-sky",
    // Unlike the other tiers, this card opens the dedicated workshops
    // listing (Time Management + Effective Studying toolkits) rather than
    // a sign-up form.
    ctaLabel: "Explore workshops",
    ctaHref: "/workshops/explore",
    ctaExternal: false
  }
];
