...
export const REWARDS: Reward[] = [
  ...
  { id: "garden-cottage", name: "Cozy cottage", category: "garden-structures", price: 240, emoji: "🏡", description: "A little wooden cottage at the edge of your garden.", art: "/garden/item-cottage.webp", placement: { x: 8, y: 67, scale: 1.35, layer: 2 } },
  ...
  { id: "garden-applestree", name: "Apple tree", category: "garden-plants", price: 180, emoji: "🍎", description: "A small tree heavy with bright red apples.", art: "/garden/item-applestree.webp", placement: { x: 21, y: 74, scale: 0.9, layer: 3 } },
  { id: "garden-pond", name: "Wishing pond", category: "garden-plants", price: 180, emoji: "💧", description: "A small clear pond with a lily pad or two. Ripples subtly.", art: "/garden/item-pond.webp", placement: { x: 88, y: 91, scale: 1.1, layer: 5 } },
  { id: "garden-pumpkinpatch", name: "Pumpkin patch", category: "garden-plants", price: 130, emoji: "🎃", description: "Three plump orange pumpkins on a vine.", art: "/garden/item-pumpkinpatch.webp", placement: { x: 24, y: 94, scale: 0.8, layer: 6 } },
  ...
  { id: "garden-scarecrow", name: "Cheery scarecrow", category: "garden-critters", price: 160, emoji: "🧑‍🌾", description: "A smiling scarecrow with a straw hat and overalls.", art: "/garden/item-scarecrow.webp", placement: { x: 41, y: 82, scale: 0.85, layer: 4 } },
  { id: "garden-gnome", name: "Garden gnome", category: "garden-critters", price: 280, emoji: "🧙", description: "A friendly gnome watching over your tree.", art: "/garden/item-gnome.webp", placement: { x: 46, y: 95, scale: 0.55, layer: 7 } },
  { id: "garden-birdbath", name: "Bird bath", category: "garden-critters", price: 150, emoji: "🪺", description: "A stone bowl where little birds come to splash.", art: "/garden/item-birdbath.webp", placement: { x: 70, y: 91, scale: 0.75, layer: 5 } },
  { id: "garden-frogstatue", name: "Lily-pad frog", category: "garden-critters", price: 130, emoji: "🐸", description: "A round stone frog statue with a lotus on its head.", art: "/garden/item-frogstatue.webp", placement: { x: 76, y: 95, scale: 0.5, layer: 6 } },
