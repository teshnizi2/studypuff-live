function Header() {
  ...
  const NAV = [
    ...
    { label:"Study with us",   href:"study.html" },
    { label:"StudyPuff App",   href:"dashboard.html" },
    { label:"Workshops",       href:"workshops.html" },
    { label:"Free Resources",  href:"resources.html" },
    { label:"Store",           href:"store.html" },
    { label:"About",           href:"about.html" },
    { label:"FAQ",             href:"faq.html" },
    { label:"Contact",         href:"contact.html" }
  ];
  const path = (typeof location !== "undefined" ? location.pathname.split("/").pop() : "") || "Home.html";
  const isActive = (href) => {
    const h = href.split("#")[0].split("/").pop();
    if (!h) return path === "Home.html" || path === "";
    return h === path;
  };
  return (
    <header className="sticky top-0 z-40 border-b border-ink-900/10 bg-[rgba(239,236,236,0.88)] backdrop-blur-md">
      <div className="mx-auto flex max-w-[1400px] items-center gap-6 px-6 py-3 lg:px-12">
        <a href="Home.html" className="flex shrink-0 items-center" aria-label="StudyPuff Academy">
          <img src="public/studypuff-logo-sm.png" alt="StudyPuff Academy"
        ...
        <div className="hidden shrink-0 items-center gap-3 lg:flex">
          <a href="coming-soon.html"    className="text-[14px] text-ink-700 hover:text-ink-900">Sign in</a>
          <a href="coming-soon.html" className="btn-ink !py-2 !px-4 !text-[13px]">Get started <I.arrow/></a>
        </div>
      ...
      {open && (
        <div className="border-t border-ink-900/10 px-6 py-5 lg:hidden bg-cream-100">
          <div className="mb-4 flex gap-2">
            <a href="coming-soon.html"    className="btn-ghost flex-1 !py-2">Sign in</a>
            <a href="coming-soon.html" className="btn-ink flex-1 !py-2">Get started</a>
          </div>
